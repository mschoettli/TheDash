...
export default function TileMinimal({ tile, status, apiData }: Props) {
  ...
  return (
    <div className="tile-glass relative flex h-full flex-col items-center justify-center gap-1.5 overflow-hidden rounded-xl border border-line/45 p-3 text-center shadow-sm transition-all duration-150 hover:-translate-y-0.5 hover:border-accent/30 hover:shadow-lg hover:shadow-accent/5">
