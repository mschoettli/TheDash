...
export default function TileCompact({ tile, status, apiData }: Props) {
  return (
    <div className="tile-glass relative flex h-full items-center gap-2.5 overflow-hidden rounded-2xl border border-line/40 px-3 py-2 transition-colors duration-150 hover:border-accent/30">
